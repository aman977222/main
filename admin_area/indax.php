...
.admin-image {
   ...
   border: 4px solid rgb(234, 233, 239);
}
    </style>
</head>
<body>
    ...
    if (!isset($_SESSION['admin_name'])) {
        ...
        <li class='nav-item'>
            <a class='nav-link text-black' href='admin_logout.php'><i class='fa-solid fa-right-from-bracket'></i></a>
        </li>";
    }
    ?>
</ul>
